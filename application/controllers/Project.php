	...
	public function task_list(){
		...
		foreach($taskArr as $row) {
			if($row->status == 0){
				...
				$actionStr = '<a href="javascript:;"  class="btn btn-info btn-circle edit-task" data-toggle="tooltip" data-task-id="69" data-original-title="Edit" id="updateTask"><i class="fa fa-pencil" 		aria-hidden="true"></i></a> &nbsp;
