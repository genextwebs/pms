	...
	<div class="container">
		<div>
			<div align="left">
				...
				<h4>'.$userData[0]->emailid.'</h4>
				<h4>'.$userData[0]->mobile.'</h4>
			</div>
			<div align="right">
				<h3>Generated By:</h3>
		...
		<div class="row">
			<div class="col-sm-6">
				<h3>'.$invoiceData[0]->invoice.'</h3>
				<h4>Project Name: '.$projectData[0]->projectname.'</h4>
				<h4>Invoice Date: '.$invoicdate.'</h4>
				<h4>Status: '.$status.'</h4>
			</div>
		</div>
