...
<a href="<?php echo base_url().'Estimates/viewestimate'?>">Add New Estimate</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	...
	<script type="text/javascript">
		jQuery(document).ready(function() {
			var oTable = jQuery('#example').DataTable({
				order: [[1, 'asc']],
				bServerSide: true,
				sAjaxSource: "<?php echo base_url(); ?>Estimates/viewestimaterecord",
				sServerMethod: "POST",
